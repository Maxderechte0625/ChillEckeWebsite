...
const config = {
    serverInfo: {
        ...
        serverName: "SpaceCity", /*Server name*/
        serverIp: "spacecity.world", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1278516842192834623" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
...
const getDiscordOnlineUsers = async () => {
    try {
        ...
        const apiWidgetUrl = `https://discord.com/api/guilds/1278516842192834623/widget.json`;
